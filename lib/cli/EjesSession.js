...
let EjesSession = /** @class */ (() => {
    class EjesSession extends imperative_1.Session {
        constructor(newSession) {
            ...
            this.DEBUG_BLOCKING = 16;
            this.DEBUG_FETCHING = 32;
            this.DEBUG_OUTPUT = 64;
            this.DEBUG_FETCHING_OUTPUT = this.DEBUG_FETCHING + this.DEBUG_OUTPUT; // 80
            this.DEBUG_TIMER = 128;
            this.columns = 240;
            this.rows = 63;
            this.rowOverhead = 6;
            this.block = "";
