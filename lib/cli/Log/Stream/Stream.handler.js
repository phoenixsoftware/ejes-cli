        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const fetchData = () => __awaiter(this, void 0, void 0, function* () {
                ...
                do {
                    try {
                        if (ip) {
                            response = yield Ejes_1.Ejes.init(this.session, ip, { enumValue: this.session.initialEnumeration, command: cmd = cmdPrimary }, this.params.arguments.debug);
                            ip = undefined;
            ...
            const startAsync = () => __awaiter(this, void 0, void 0, function* () {
                while (!signal) {
                    ...
                    if (signal)
                        break;
                    yield wait(params.arguments.timerInterval);
                }
            });
            yield startAsync();
        });
