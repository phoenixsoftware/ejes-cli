...
(0, Shared_1.addShared)({ obj: exports.ActivityDefinition, primary: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.APFdsDefinition, parms: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.CLassDefinition });
...
(0, Shared_1.addShared)({ obj: exports.CommandDefinition });
...
(0, Shared_1.addShared)({ obj: exports.DJcDefinition });
...
(0, Shared_1.addShared)({ obj: exports.DYNEXitDefinition, parms: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.ENClaveDefinition, system: true });
...
(0, Shared_1.addShared)({ obj: exports.ENQDefinition, parms: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.ENQCDefinition, parms: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.ENQDDefinition, parms: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.EntryDefinition });
...
(0, Shared_1.addShared)({ obj: exports.FSSDefinition });
...
(0, Shared_1.addShared)({ obj: exports.GRoupDefinition, parms: true, primary: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.HCheckDefinition, parms: true });
...
(0, Shared_1.addShared)({ obj: exports.HoldDefinition, primary: true });
...
(0, Shared_1.addShared)({ obj: exports.INITDefinition, primary: true });
...
(0, Shared_1.addShared)({ obj: exports.InputDefinition, parms: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.JESplexDefinition });
...
(0, Shared_1.addShared)({ obj: exports.JGroupDefinition });
...
(0, Shared_1.addShared)({ obj: exports.LIneDefinition, parms: true, primary: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.LNKlstDefinition, parms: true });
...
(0, Shared_1.addShared)({ obj: exports.LPAlstDefinition, parms: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.LogDefinition, parms: true });
exports.MDsDefinition = {
    name: "mds",
    aliases: ["md"],
...
(0, Shared_1.addShared)({ obj: exports.MDsDefinition, primary: true });
...
(0, Shared_1.addShared)({ obj: exports.MEMUsageDefinition, parms: true, primary: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.MenuDefinition, parms: true });
...
(0, Shared_1.addShared)({ obj: exports.MOuntsDefinition, parms: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.NETConnDefinition, parms: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.NETSERVDefinition, system: true });
...
(0, Shared_1.addShared)({ obj: exports.NJEDefinition, primary: true });
...
(0, Shared_1.addShared)({ obj: exports.NOdeDefinition, parms: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.OFFloadDefinition });
...
(0, Shared_1.addShared)({ obj: exports.OutputDefinition, parms: true, primary: true });
...
(0, Shared_1.addShared)({ obj: exports.PAGedsDefinition, parms: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.PARMlibDefinition });
...
(0, Shared_1.addShared)({ obj: exports.PRinterDefinition, parms: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.PROClibDefinition });
...
(0, Shared_1.addShared)({ obj: exports.PStatusDefinition, parms: true, primary: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.QueryDefinition, parms: true, parmRequired: true });
...
(0, Shared_1.addShared)({ obj: exports.RESMonDefinition, parms: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.RESOurceDefinition, parms: true });
...
(0, Shared_1.addShared)({ obj: exports.SCHenvDefinition, parms: true });
...
(0, Shared_1.addShared)({ obj: exports.SessionDefinition, parms: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.SPArtDefinition, parms: true });
...
(0, Shared_1.addShared)({ obj: exports.SPVolDefinition });
...
(0, Shared_1.addShared)({ obj: exports.StatusDefinition, primary: true });
...
(0, Shared_1.addShared)({ obj: exports.SUBSYStemDefinition, primary: true });
...
(0, Shared_1.addShared)({ obj: exports.SYMbolDefinition, parms: true, system: true });
...
(0, Shared_1.addShared)({ obj: exports.SYSClsDefinition });
...
(0, Shared_1.addShared)({ obj: exports.SYSplexDefinition, system: true });
...
(0, Shared_1.addShared)({ obj: exports.SYSReqDefinition, parms: true });
...
(0, Shared_1.addShared)({ obj: exports.UlogDefinition, parms: true });
...
(0, Shared_1.addShared)({ obj: exports.WriterDefinition, parms: true, primary: true });
...
(0, Shared_1.addShared)({ obj: exports.ZeroDefinition, parms: true, primary: true });
exports.Definition = {
    name: "Placeholder",
    aliases: ["ph"],
    summary: "* Display .",
...
(0, Shared_1.addShared)({ obj: exports.Definition, parms: true, primary: true, system: true });
