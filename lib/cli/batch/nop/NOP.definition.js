...
exports.NOPDefinition = void 0;
exports.NOPDefinition = {
    name: "nop",
    summary: "# Start/resume session with no operation.",
    description: "Start or resume a session with no operation.  Most useful in conjunction with --resume.",
    type: "command",
    ...
    options: [
        ...
        {
            name: "resume",
            description: "For use with the pause meta command.  Use \"off\" to prevent resuming an auto pin session.    Most useful in conjunction with --resume.",
            type: "array",
            aliases: ["r"]
        },
        {
...
//# sourceMappingURL=NOP.definition.js.map