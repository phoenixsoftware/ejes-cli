...
*/
const EjesProfile_1 = require("./cli/EjesProfile");
const config = {
    ...
    profiles: [{
            ...
            schema: {
                ...
                properties: {
                    protocol: {
                        type: "string",
                        optionDefinition: EjesProfile_1.EjesProfile.EJES_OPTION_PROTOCOL,
                    },
                    host: {
                        type: "string",
                        optionDefinition: EjesProfile_1.EjesProfile.EJES_OPTION_HOST,
                    },
                    port: {
                        type: "number",
                        optionDefinition: EjesProfile_1.EjesProfile.EJES_OPTION_PORT,
                    },
                    user: {
                        type: "string",
                        secure: true,
                        optionDefinition: EjesProfile_1.EjesProfile.EJES_OPTION_USER,
                    },
                    password: {
                        type: "string",
                        secure: true,
                        optionDefinition: EjesProfile_1.EjesProfile.EJES_OPTION_PASSWORD,
                    },
                    rejectUnauthorized: {
                        type: "boolean",
                        optionDefinition: EjesProfile_1.EjesProfile.EJES_OPTION_REJECT_UNAUTHORIZED,
                    },
                    basePath: {
                        type: "string",
                        optionDefinition: EjesProfile_1.EjesProfile.EJES_OPTION_BASE_PATH,
                    },
                    colorScheme: {
                        type: "string",
                        optionDefinition: EjesProfile_1.EjesProfile.EJES_OPTION_COLOR_SCHEME,
                    },
                    noColor: {
                        type: "string",
                        optionDefinition: EjesProfile_1.EjesProfile.EJES_OPTION_NO_COLOR,
                    },
                },
                required: ["host"],
            },
