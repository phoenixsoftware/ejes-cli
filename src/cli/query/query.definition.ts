...
const ACtivityDefinition: ICommandDefinition = {
    name: "activity",
    aliases: ["ac"],
...
const APFdsDefinition: ICommandDefinition = {
        name: "apfds",
        aliases: ["apf"],
...
const CLassDefinition: ICommandDefinition = {
        name: "class",
        aliases: ["cl"],
...
const DJcDefinition: ICommandDefinition = {
     name: "djc",
     aliases: ["dj"],
...
const DYNEXitDefinition: ICommandDefinition = {
        name: "dynexit",
        aliases: ["dynex", "dynx"],
...
const ENClaveDefinition: ICommandDefinition = {
        name: "enclave",
        aliases: ["enc"],
...
const ENQDefinition: ICommandDefinition = {
        name: "enq",
        summary: " - ENQ table",
...
const ENQCDefinition: ICommandDefinition = {
        name: "enqc",
...
const ENQDDefinition: ICommandDefinition = {
        name: "enqd",
...
const FSSDefinition: ICommandDefinition = {
        name: "fss",
...
const GRoupDefinition: ICommandDefinition = {
        name: "group",
        aliases: ["gr"],
...
const HCheckDefinition: ICommandDefinition = {
        name: "hcheck",
        aliases: ["hchk", "hc"],
...
const InputDefinition: ICommandDefinition = {
        name: "input",
        aliases: ["i"],
        summary: " - Input table",
...
const JESplexDefinition: ICommandDefinition = {
        name: "jesplex",
        aliases: ["jesp"],
...
const JGroupDefinition: ICommandDefinition = {
        name: "jgroup",
        aliases: ["jg"],
...
const LIneDefinition: ICommandDefinition = {
        name: "line",
        aliases: ["li"],
        summary: " - JES3 dependent job network control table",
...
const LNKlstDefinition: ICommandDefinition = {
        name: "lnklst",
        aliases: ["lnkl", "lnk"],
...
const LPAlstDefinition: ICommandDefinition = {
        name: "lpalst",
        aliases: ["lpal", "lpa"],
...
const MDsDefinition: ICommandDefinition = {
        name: "mds",
        aliases: ["md"],
...
const MEMUsageDefinition: ICommandDefinition = {
        name: "memusage",
        aliases: ["memuse", "memu"],
...
const MOuntsDefinition: ICommandDefinition = {
        name: "mounts",
        aliases: ["mount", "mo"],
...
const NETConnDefinition: ICommandDefinition = {
        name: "netconn",
        aliases: ["netc", "nc"],
...
const NETSERVDefinition: ICommandDefinition = {
        name: "netserv",
        aliases: ["nets"],
...
const NJEDefinition: ICommandDefinition = {
        name: "nje",
...
const NOdeDefinition: ICommandDefinition = {
        name: "node",
        aliases: ["node", "no"],
        summary: " - Node table",
...
const OFFloadDefinition: ICommandDefinition = {
        name: "offload",
        aliases: ["off"],
...
const PAGedsDefinition: ICommandDefinition = {
        name: "pageds",
...
const PARMlibDefinition: ICommandDefinition = {
        name: "parmlib",
        aliases: ["parml", "parm"],
...
const PRinterDefinition: ICommandDefinition = {
        name: "printer",
        aliases: ["pr"],
...
const PROClibDefinition: ICommandDefinition = {
        name: "proclib",
        aliases: ["procl", "proc"],
...
const PStatusDefinition: ICommandDefinition = {
        name: "pstatus",
        aliases: ["pstat", "ps"],
...
const RESMonDefinition: ICommandDefinition = {
        name: "resmon",
...
const RESOurceDefinition: ICommandDefinition = {
        name: "resource",
        aliases: ["reso"],
...
const SCHenvDefinition: ICommandDefinition = {
        name: "schenv",
        aliases: ["sch"],
...
const SessionDefinition: ICommandDefinition = {
        name: "session",
        aliases: ["ses"],
...
const SPArtDefinition: ICommandDefinition = {
        name: "spart",
        aliases: ["spa"],
...
const SPVolDefinition: ICommandDefinition = {
        name: "spvol",
        aliases: ["spv"],
...
const StatusDefinition: ICommandDefinition = {
        name: "status",
        aliases: ["st"],
...
const SYSClsDefinition: ICommandDefinition = {
        name: "syscls",
        aliases: ["sysc"],
...
const SYSplexDefinition: ICommandDefinition = {
        name: "sysplex",
        aliases: ["sysp", "sys"],
...
const SYSReqDefinition: ICommandDefinition = {
        name: "sysreq",
        aliases: ["sysr", "sr"],
...
const WriterDefinition: ICommandDefinition = {
        name: "writer",
        aliases: ["w", "output", "o"],
...
const ZeroDefinition: ICommandDefinition = {
        name: "zero",
        aliases: ["z"],
...
const QueryDefinition: ICommandDefinition = {
    name: "query",
    aliases: ["q"],
    ...
    description: "Query the host using (E)JES.  Return host spool, dataset, and library tables.  " +
        ...
        "Issue these commands as an introduction: " +
        "(1) \"zowe ejes query list\" to show available tables." +
        "(2) \"zowe ejes query status --owner help\" to demonstrate how to find how it all works. " +
        "(3) \"zowe ejes query status --owner list\" to demonstrate how to find appropriate arguments. " +
        "(4) \"zowe ejes query status --owner myuserid --sort time d\" to view a sorted table of your jobs." +
        "(5) \"zowe ejes query status --owner myuserid --sort time d --report \" to view the first job in report form (truncated to your screen).",
    type: "group",
...
//        },
        ...
        },
        {
            property: "options",
            value: [
                { name: "metafilter", group: GENERAL_OPTIONS, // WARNING: Must be in this position to set group category order.
                    aliases: ["m"],
                    type: "array",
                ...
                { name: "dest", group: PSEL_OPTIONS, // WARNING: Must be in this position to set group category order.
                    type: "string",
                ...
                { name: "header", group: QUERY_OPTIONS, // WARNING: Must be in this position to set group category order.
                    type: "string",
                ...
                { name: "actpurge", group: CMD_OPTIONS, // WARNING: Must be in this position to set group category order.
                    type: "string",
                ...
                { name: "submit", group: SUBMIT_OPTIONS, // WARNING: Must be in this position to set group category order.
                    aliases: ["submit", "sub"],
                    type: "string",
                ...
                { name: "debug", group: TEST_OPTIONS, // WARNING: Must be in this position to set group category order.
                ...
                { name: "atx", group: PSEL_OPTIONS_ADVANCED, // WARNING: Must be in this position to set group category order.
                    type: "string",
                ...
                { name: "acplex", group: QUERY_OPTIONS_ADVANCED, // WARNING: Must be in this position to set group category order.
                    type: "string",
